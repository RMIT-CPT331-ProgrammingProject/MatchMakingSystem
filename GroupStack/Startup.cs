    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ApplicationDbContext>(options =>
                    /*options.UseSqlServer(Environment.GetEnvironmentVariable("MYSQLCONNSTR_localdb"))*/
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ApplicationDbContext context, UserManager<IdentityUser> userManager, RoleManager<IdentityRole> roleManager)
        {
            ...
            InitialiseDB(context, userManager, roleManager).Wait();
        }

        private async Task InitialiseDB(ApplicationDbContext context, UserManager<IdentityUser> userManager, RoleManager<IdentityRole> roleManager)
        {
